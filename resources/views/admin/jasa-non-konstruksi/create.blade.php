...
@section('title', 'Tambah Jasa Non Konstruksi Baru')
...
<div class="container mt-4">
    <div class="card card-custom">
        <div class="card-header-custom">
            <h4 class="mb-0">Tambah Jasa Non Konstruksi Baru</h4>
        </div>
        <div class="card-body">
            @if ($errors->any())
            ...
            <form id="createForm" action="{{ route('jasa-non-konstruksi.store') }}" method="POST" enctype="multipart/form-data" novalidate>
                @csrf
                <div class="mb-3">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="confirmModalLabel">Konfirmasi Simpan Jasa Non Konstruksi</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                Apakah Anda yakin ingin menambahkan data jasa non konstruksi ini?
            </div>
