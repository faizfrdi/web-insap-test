...
@section('title', 'Edit FAQ PS Module - Capex Procurement')
...
<div class="container mt-4">
    <div class="card card-custom">
        <div class="card-header-custom">
            <h4 class="mb-0">Edit FAQ PS Module - Capex Procurement</h4>
        </div>
        <div class="card-body">
            @if ($errors->any())
            ...
            <form id="editForm" action="{{ route('faq-capex-procurement.ps-module.update', $faq->id) }}" method="POST" enctype="multipart/form-data" novalidate>
                @csrf
                @method('PUT')
                ...
                <div class="mb-3">
                    ...
                    @if ($faq->image)
                        <div class="text-center mt-3">
                            ...
                            <img src="{{ asset('images/faq-capex-procurement/ps/' . $faq->image) }}" 
                                alt="{{ $faq->question }}" 
                ...
                <div class="d-flex justify-content-end mt-3">
                    <a href="{{ route('faq-capex-procurement.ps-module.index') }}" class="btn btn-secondary me-2 btn-custom">Batal</a>
