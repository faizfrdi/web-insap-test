...
@section('title', 'Tambah FAQ CO/FM Module - Internal Project')
...
<div class="container mt-4">
    <div class="card card-custom">
        <div class="card-header-custom">
            <h4 class="mb-0">Tambah FAQ CO/FM Module Baru - Internal Project</h4>
        </div>
        <div class="card-body">
            @if ($errors->any())
            ...
            <form id="createForm" action="{{ route('faq-internal-project.co-fm-module.store') }}" method="POST" enctype="multipart/form-data" novalidate>
                @csrf
                <div class="mb-3">
