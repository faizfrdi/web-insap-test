...
@section('title', 'Edit FAQ CO/FM Module - Jasa Konstruksi')
...
<div class="container mt-4">
    <div class="card card-custom">
        <div class="card-header-custom">
            <h4 class="mb-0">Edit FAQ CO/FM Module - Jasa Konstruksi</h4>
        </div>
        <div class="card-body">
            @if ($errors->any())
            ...
            <form id="editForm" action="{{ route('faq-jasa-konstruksi.co-fm-module.update', $faq->id) }}" method="POST" enctype="multipart/form-data" novalidate>
                @csrf
                @method('PUT')
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control @error('answer') is-invalid @enderror" id="answer" name="answer" rows="3" required>{!! old(formatTextForHtml('answer'), formatTextForHtml($faq->answer)) !!}</textarea>
                    @error('answer')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="mb-3">
                    ...
                    @if ($faq->image)
                        <div class="text-center mt-3">
                            ...
                            <img src="{{ asset('images/faq-jasa-konstruksi/co-fm/' . $faq->image) }}" 
                                alt="{{ $faq->question }}" 
                ...
                <div class="d-flex mt-3">
                    <a href="{{ route('faq-jasa-konstruksi.co-fm-module.index') }}" class="btn btn-secondary me-2 btn-custom">Batal</a>
...
<script>
    document.getElementById('openModalBtn').addEventListener('click', function() {
        ...
        var originalAnswer = @json($faq->answer);
