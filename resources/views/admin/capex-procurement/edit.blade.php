...
@section('title', 'Edit Capex Procurement')
...
<div class="container mt-4">
    <div class="card card-custom">
        <div class="card-header-custom">
            <h4 class="mb-0">Edit Capex Procurement</h4>
        </div>
        <div class="card-body">
            @if ($errors->any())
            ...
            <form id="editForm" action="{{ route('capex-procurement.update', $capex_procurement->id) }}" method="POST" enctype="multipart/form-data" novalidate>
                @csrf
                @method('PUT')

                <div class="mb-3">
                    <label for="judul" class="form-label">Judul Capex Procurement</label>
                    <input type="text" class="form-control @error('judul') is-invalid @enderror" id="judul" name="judul" value="{{ old('judul', $capex_procurement->judul) }}" required>
                    @error('judul')
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control @error('input_process') is-invalid @enderror" id="input_process" name="input_process" rows="3" required>{{ old('input_process', $capex_procurement->input_process) }}</textarea>
                    @error('input_process')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control @error('output_process') is-invalid @enderror" id="output_process" name="output_process" rows="3">{{ old('output_process', $capex_procurement->output_process) }}</textarea>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('pic') is-invalid @enderror" id="pic" name="pic" value="{{ old('pic', $capex_procurement->pic) }}">
                    @error('pic')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('t_code') is-invalid @enderror" id="t_code" name="t_code" value="{{ old('t_code', $capex_procurement->t_code) }}">
                    @error('t_code')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control @error('proses') is-invalid @enderror" id="proses" name="proses" rows="3">{{ old('proses', $capex_procurement->proses) }}</textarea>
                    @error('proses')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('link_terkait') is-invalid @enderror" id="link_terkait" name="link_terkait" value="{{ old('link_terkait', $capex_procurement->link_terkait) }}">
                    @error('link_terkait')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="mb-3">
                    <label for="urutan" class="form-label">Urutan Capex Procurement</label>
                    <input type="text" class="form-control @error('urutan') is-invalid @enderror" id="urutan" name="urutan" value="{{ old('urutan', $capex_procurement->urutan) }}" required>
                    @error('urutan')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select @error('module') is-invalid @enderror" id="module" name="module" required>
                        ...
                        <option value="FI Module" {{ (old('module', $capex_procurement->module) == 'FI Module') ? 'selected' : '' }}>FI Module</option>
                        <option value="SD Module" {{ (old('module', $capex_procurement->module) == 'SD Module') ? 'selected' : '' }}>SD Module</option>
                        <option value="PS Module" {{ (old('module', $capex_procurement->module) == 'PS Module') ? 'selected' : '' }}>PS Module</option>
                        <option value="CO/FM Module" {{ (old('module', $capex_procurement->module) == 'CO/FM Module') ? 'selected' : '' }}>CO/FM Module</option>
                        <option value="MM Module" {{ (old('module', $capex_procurement->module) == 'MM Module') ? 'selected' : '' }}>MM Module</option>
                    </select>
                    @error('module')
                        <div class="invalid-feedback">
                            {{ $message }}
                ...
                <div class="mb-3">
                    ...
                    @if ($capex_procurement->image)
                        <div class="text-center mt-3">
                            ...
                            <img src="{{ asset('images/capex_procurement/' . $capex_procurement->image) }}" 
                                alt="{{ $capex_procurement->judul }}" 
                                class="capex-procurement-image img-fluid mx-auto">
                        </div>
                    @endif
                    @error('image')
                        <div class="invalid-feedback">
                ...
                <div class="mb-3 text-center" id="newImageContainer" style="display: none;">
                    ...
                    <img id="imagePreview" src="#" alt="Preview" class="capex-procurement-image img-fluid mx-auto">
                </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="confirmUpdateModalLabel">Konfirmasi Update Capex Procurement</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                Apakah Anda yakin ingin memperbarui data capex procurement ini?
            </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const originalData = {
            judul: '{!! $capex_procurement->judul !!}',
            input_process: '{!! $capex_procurement->input_process !!}',
            output_process: '{!! $capex_procurement->output_process !!}',
            pic: '{!! $capex_procurement->pic !!}',
            t_code: '{!! $capex_procurement->t_code !!}',
            proses: '{!! $capex_procurement->proses !!}',
            link_terkait: '{!! $capex_procurement->link_terkait !!}',
            urutan: '{!! $capex_procurement->urutan !!}',
            module: '{!! $capex_procurement->module !!}'
        };
