...
<div class="container mt-4">
    <div class="card card-custom">
        <div class="card-header-custom">
            <h4 class="mb-0">Edit Internal Project</h4>
        </div>
        <div class="card-body">
            @if ($errors->any())
            ...
            <form id="editForm" action="{{ route('internal-project.update', $internal_project->id) }}" method="POST" enctype="multipart/form-data" novalidate>
                @csrf
                @method('PUT')

                <div class="mb-3">
                    <label for="judul" class="form-label">Judul Internal Project</label>
                    <input type="text" class="form-control @error('judul') is-invalid @enderror" id="judul" name="judul" value="{{ old('judul', $internal_project->judul) }}" required>
                    @error('judul')
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control @error('input_process') is-invalid @enderror" id="input_process" name="input_process" rows="3" required>{{ old('input_process', $internal_project->input_process) }}</textarea>
                    @error('input_process')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control @error('output_process') is-invalid @enderror" id="output_process" name="output_process" rows="3">{{ old('output_process', $internal_project->output_process) }}</textarea>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('pic') is-invalid @enderror" id="pic" name="pic" value="{{ old('pic', $internal_project->pic) }}">
                    @error('pic')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('t_code') is-invalid @enderror" id="t_code" name="t_code" value="{{ old('t_code', $internal_project->t_code) }}">
                    @error('t_code')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control @error('proses') is-invalid @enderror" id="proses" name="proses" rows="3">{{ old('proses', $internal_project->proses) }}</textarea>
                    @error('proses')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('link_terkait') is-invalid @enderror" id="link_terkait" name="link_terkait" value="{{ old('link_terkait', $internal_project->link_terkait) }}">
                    @error('link_terkait')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="mb-3">
                    <label for="urutan" class="form-label">Urutan Internal Project</label>
                    <input type="text" class="form-control @error('urutan') is-invalid @enderror" id="urutan" name="urutan" value="{{ old('urutan', $internal_project->urutan) }}" required>
                    @error('urutan')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select @error('module') is-invalid @enderror" id="module" name="module" required>
                        ...
                        <option value="FI Module" {{ (old('module', $internal_project->module) == 'FI Module') ? 'selected' : '' }}>FI Module</option>
                        <option value="SD Module" {{ (old('module', $internal_project->module) == 'SD Module') ? 'selected' : '' }}>SD Module</option>
                        <option value="PS Module" {{ (old('module', $internal_project->module) == 'PS Module') ? 'selected' : '' }}>PS Module</option>
                        <option value="CO/FM Module" {{ (old('module', $internal_project->module) == 'CO/FM Module') ? 'selected' : '' }}>CO/FM Module</option>
                        <option value="MM Module" {{ (old('module', $internal_project->module) == 'MM Module') ? 'selected' : '' }}>MM Module</option>
                    </select>
                    @error('module')
                        <div class="invalid-feedback">
                            {{ $message }}
                ...
                <!-- Bagian Gambar Utama -->
                <div class="mb-3">
                    <label for="image" class="form-label">Gambar Internal Project</label>
                    ...
                    @if ($internal_project->image)
                        <div class="text-center mt-3">
                            ...
                            <img src="{{ asset('images/internal_project/' . $internal_project->image) }}" 
                                ...
                                class="internal-project-image img-fluid mx-auto">
                        </div>
                    @endif
                    @error('image')
                        <div class="invalid-feedback">
                ...
                <div class="mb-3 text-center" id="newImageContainer" style="display: none;">
                    ...
                    <img id="imagePreview" src="#" alt="Preview" class="internal-project-image img-fluid mx-auto">
                </div>

                <div class="d-flex justify-content-end mt-3">
                    <a href="{{ route('internal-project.index') }}" class="btn btn-secondary me-2 btn-custom">Batal</a>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="confirmUpdateModalLabel">Konfirmasi Update Internal Project</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                Apakah Anda yakin ingin memperbarui data internal project ini?
            </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const originalData = {
            judul: '{!! $internal_project->judul !!}',
            input_process: '{!! $internal_project->input_process !!}',
            output_process: '{!! $internal_project->output_process !!}',
            pic: '{!! $internal_project->pic !!}',
            t_code: '{!! $internal_project->t_code !!}',
            proses: '{!! $internal_project->proses !!}',
            link_terkait: '{!! $internal_project->link_terkait !!}',
            urutan: '{!! $internal_project->urutan !!}',
            module: '{!! $internal_project->module !!}'
        };
