...
@section('title', 'Detail Proyek Manufacturing')

@section('content')
    <div class="p-5" style="border-radius: 15px; border: 1px solid #ddd; background-color: #fbfbfd;">
        <div class="text-center mb-4">
            <h3><strong>DETAIL PROYEK MANUFACTURING</strong></h3>
        </div>
        
        <div class="grid-layout">
            <!-- Judul -->
            <div class="item">
                <div class="item-header">{{ $manufacturing->module ?? '-' }}</div>
                <div class="item-content">
                    <p>{{ $manufacturing->judul }}</p>
                </div>
            </div>
            ...
            <div class="item">
                ...
                <div class="item-content">
                    <p>{{ $manufacturing->input_process }}</p>
                </div>
            </div>
            ...
            <div class="item">
                ...
                <div class="item-content">
                    <p>{{ $manufacturing->output_process ?? '-' }}</p>
                </div>
            </div>
