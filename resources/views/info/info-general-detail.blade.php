...
@section('title', 'Detail Updates Info General')
...
<div class="p-5" style="border-radius: 15px; border: 1px solid #ddd; background-color: #fbfbfd;">
    ...
    <div class="grid-layout">
        ...
        <div class="item">
            ...
            <div class="item-content">
                <a href="{{ asset('files/info_general/' . $report->file) }}" target="_blank">
    ...
    <div class="image-section mt-4 text-center">
        <img src="{{ asset('images/info_general/' . $report->image) }}"
             alt="Gambar"
             class="img-fluid"
    ...
    <div class="mt-4 text-left">
        <a href="{{ url('/info/info-general') }}" class="btn btn-secondary">Kembali</a>
    </div>
</div>
