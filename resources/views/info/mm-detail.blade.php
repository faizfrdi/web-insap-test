...
@section('title', 'Detail Updates MM')
...
<div class="p-5" style="border-radius: 15px; border: 1px solid #ddd; background-color: #fbfbfd;">
    ...
    <div class="grid-layout">
        ...
        <div class="item">
            ...
            <div class="item-content">
                <a href="{{ asset('files/mm/' . $report->file) }}" target="_blank">
    ...
    <div class="image-section mt-4 text-center">
        <img src="{{ asset('images/mm/' . $report->image) }}"
             alt="Gambar"
             class="img-fluid"
    ...
    <div class="mt-4 text-left">
        <a href="{{ url('/info/mm') }}" class="btn btn-secondary">Kembali</a>
    </div>
</div>
