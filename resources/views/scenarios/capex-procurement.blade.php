...
@section('title', 'Detail Proyek Capex Procurement')

@section('content')
    <div class="p-5" style="border-radius: 15px; border: 1px solid #ddd; background-color: #fbfbfd;">
        <div class="text-center mb-4">
            <h3><strong>DETAIL PROYEK CAPEX PROCUREMENT</strong></h3>
        </div>
        
        <div class="grid-layout">
            <!-- Judul -->
            <div class="item">
                <div class="item-header">{{ $capex_procurement->module ?? '-' }}</div>
                <div class="item-content">
                    <p>{{ $capex_procurement->judul }}</p>
                </div>
            </div>
            ...
            <div class="item">
                ...
                <div class="item-content">
                    <p>{{ $capex_procurement->input_process }}</p>
                </div>
            </div>
            ...
            <div class="item">
                ...
                <div class="item-content">
                    <p>{{ $capex_procurement->output_process ?? '-' }}</p>
                </div>
            </div>
            ...
            <div class="item large-card">
                ...
                <div class="item-content">
                    <p>
                        @if($capex_procurement->link_terkait)
