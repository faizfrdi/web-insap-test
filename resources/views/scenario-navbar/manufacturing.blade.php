...
@section('content')
    <div id="flow-section" class="text-center p-3 p-md-5 mb-5" style="border-radius: 15px; border: 1px solid #ddd; background-color: #fbfbfd;">
        <h2 class="section-title mb-4" style="font-size: min(24px, 5vw);">FLOW END TO END ALL PROCESS SCENARIO MANUFACTURING</h2>
        ...
        <div class="d-flex flex-column flex-md-row justify-content-center align-items-center">
            <div class="image-container position-relative" style="width: 100%; max-width: 800px; margin: 0 auto; border-radius: 10px; overflow: hidden;">
                <img src="{{ asset('images/scenario-manufacturing.png') }}" class="img-fluid" alt="Flow End to End Manufacturing" style="object-fit: contain; width: 100%; height: 150px;">
            </div>
    ...
    <div id="manufacturing-section" class="text-center p-3 p-md-5" style="border-radius: 15px; border: 1px solid #ddd; background-color: #fbfbfd;">
        ...
        <div id="manufacturing-content">
            <div class="row">
                @forelse ($manufacturings as $manufacturing)
                    @php
                        $moduleColors = [
                            'FI Module' => '#ff0404',
                            'PS Module' => '#aeeff0', 
                    ...
                    <div class="custom-col mb-4 manufacturing-card {{ $manufacturing->module == 'FI Module' ? 'fi-module' : '' }}" data-module="{{ $manufacturing->module }}">
                        <a href="{{ route('scenarios.manufacturing', $manufacturing->slug) }}" class="text-decoration-none">
                            <div class="card h-100 portfolio-card" style="border-radius: 10px; overflow: hidden; padding: 0; background-color: {{ $backgroundColor }}; background-size: cover; background-position: center;"> 
                                <div class="card-body" style="background: rgba(255,255,255,0.15); color: {{ $manufacturing->module == 'FI Module' ? 'white' : 'black' }};">
