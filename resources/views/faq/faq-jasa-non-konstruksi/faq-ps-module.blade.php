...
@section('content')
<!-- FAQ PS Module - Jasa Non-Konstruksi Section -->
<div class="p-5" style="border-radius: 15px; border: 1px solid #ddd; background-color: #fbfbfd;">
    <h2 class="section-title mb-4 text-center" style="font-size: min(24px, 5vw);">FAQ PS MODULE - JASA NON KONSTRUKSI</h2>
    <div class="row g-4">
        @foreach ($faqPsModules as $faq)
            <div class="col-md-6">
                <div class="accordion-item shadow-sm" style="border-radius: 10px;">
                    ...
                    <div id="collapse{{ $faq->id }}" class="accordion-collapse collapse" aria-labelledby="heading{{ $faq->id }}">
                        <div class="accordion-body">
                            <p>{{ $faq->answer }}</p>
                            @if($faq->image)
                                <img src="{{ asset('images/faq-jasa-non-konstruksi/ps/' . $faq->image) }}" alt="FAQ Image" class="img-fluid mb-3 faq-image">
                            @else
