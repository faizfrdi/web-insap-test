...
@section('title', 'Tambah FAQ General - Capex Procurement')
...
<div class="container mt-4">
    <div class="card card-custom">
        <div class="card-header-custom">
            <h4 class="mb-0">Tambah FAQ General Baru - Capex Procurement</h4>
        </div>
        <div class="card-body">
            @if ($errors->any())
            ...
            <form id="createForm" action="{{ route('faq-capex-procurement.general.store') }}" method="POST" enctype="multipart/form-data" novalidate>
                @csrf
                <div class="mb-3">
