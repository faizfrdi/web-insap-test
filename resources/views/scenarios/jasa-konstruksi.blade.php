...
@section('title', 'Detail Proyek Jasa Konstruksi')

@section('content')
    <div class="p-5" style="border-radius: 15px; border: 1px solid #ddd; background-color: #fbfbfd;">
        <div class="text-center mb-4">
            <h3><strong>DETAIL PROYEK JASA KONSTRUKSI</strong></h3>
        </div>
        
        <div class="grid-layout">
            <!-- Judul -->
            <div class="item">
                <div class="item-header">{{ $jasa_konstruksi->module ?? '-' }}</div>
                <div class="item-content">
                    <p>{{ $jasa_konstruksi->judul }}</p>
                </div>
            </div>
            ...
            <div class="item">
                ...
                <div class="item-content">
                    <p>{{ $jasa_konstruksi->input_process }}</p>
                </div>
            </div>
            ...
            <div class="item">
                ...
                <div class="item-content">
                    <p>{{ $jasa_konstruksi->output_process ?? '-' }}</p>
                </div>
            </div>
            ...
            <div class="item large-card">
                ...
                <div class="item-content">
                    <p>
                        @if($jasa_konstruksi->link_terkait)
