...
@section('title', 'Edit Manufacturing')
...
<div class="container mt-4">
    <div class="card card-custom">
        <div class="card-header-custom">
            <h4 class="mb-0">Edit Manufacturing</h4>
        </div>
        <div class="card-body">
            @if ($errors->any())
            ...
            <form id="editForm" action="{{ route('manufacturing.update', $manufacturing->id) }}" method="POST" enctype="multipart/form-data" novalidate>
                @csrf
                @method('PUT')

                <div class="mb-3">
                    <label for="judul" class="form-label">Judul Manufacturing</label>
                    <input type="text" class="form-control @error('judul') is-invalid @enderror" id="judul" name="judul" value="{{ old('judul', $manufacturing->judul) }}" required>
                    @error('judul')
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control @error('input_process') is-invalid @enderror" id="input_process" name="input_process" rows="3" required>{{ old('input_process', $manufacturing->input_process) }}</textarea>
                    @error('input_process')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control @error('output_process') is-invalid @enderror" id="output_process" name="output_process" rows="3">{{ old('output_process', $manufacturing->output_process) }}</textarea>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('pic') is-invalid @enderror" id="pic" name="pic" value="{{ old('pic', $manufacturing->pic) }}">
                    @error('pic')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('t_code') is-invalid @enderror" id="t_code" name="t_code" value="{{ old('t_code', $manufacturing->t_code) }}">
                    @error('t_code')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control @error('proses') is-invalid @enderror" id="proses" name="proses" rows="3">{{ old('proses', $manufacturing->proses) }}</textarea>
                    @error('proses')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('link_terkait') is-invalid @enderror" id="link_terkait" name="link_terkait" value="{{ old('link_terkait', $manufacturing->link_terkait) }}">
                    @error('link_terkait')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="mb-3">
                    <label for="urutan" class="form-label">Urutan Manufacturing</label>
                    <input type="text" class="form-control @error('urutan') is-invalid @enderror" id="urutan" name="urutan" value="{{ old('urutan', $manufacturing->urutan) }}" required>
                    @error('urutan')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select @error('module') is-invalid @enderror" id="module" name="module" required>
                        ...
                        <option value="FI Module" {{ (old('module', $manufacturing->module) == 'FI Module') ? 'selected' : '' }}>FI Module</option>
                        <option value="SD Module" {{ (old('module', $manufacturing->module) == 'SD Module') ? 'selected' : '' }}>SD Module</option>
                        <option value="PS Module" {{ (old('module', $manufacturing->module) == 'PS Module') ? 'selected' : '' }}>PS Module</option>
                        <option value="CO/FM Module" {{ (old('module', $manufacturing->module) == 'CO/FM Module') ? 'selected' : '' }}>CO/FM Module</option>
                        <option value="MM Module" {{ (old('module', $manufacturing->module) == 'MM Module') ? 'selected' : '' }}>MM Module</option>
                    </select>
                    @error('module')
                        <div class="invalid-feedback">
                            {{ $message }}
                ...
                <!-- Bagian Gambar Utama -->
                <div class="mb-3">
                    <label for="image" class="form-label">Gambar Manufacturing</label>
                    <input type="file" class="form-control @error('image') is-invalid @enderror" id="image" name="image">
                    @if ($manufacturing->image)
                        <div class="text-center mt-3">
                            <p class="form-label text-center">Gambar Saat Ini:</p>
                            <img src="{{ asset('images/manufacturing/' . $manufacturing->image) }}" 
                                alt="{{ $manufacturing->judul }}" 
                                class="manufacturing-image img-fluid mx-auto">
                        </div>
                    @endif
                    @error('image')
                        <div class="invalid-feedback">
                ...
                <div class="mb-3 text-center" id="newImageContainer" style="display: none;">
                    ...
                    <img id="imagePreview" src="#" alt="Preview" class="manufacturing-image img-fluid mx-auto">
                </div>

                <div class="d-flex justify-content-end mt-3">
                    <a href="{{ route('manufacturing.index') }}" class="btn btn-secondary me-2 btn-custom">Batal</a>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="confirmUpdateModalLabel">Konfirmasi Update Manufacturing</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                Apakah Anda yakin ingin memperbarui data manufacturing ini?
            </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const originalData = {
            judul: '{!! $manufacturing->judul !!}',
            input_process: '{!! $manufacturing->input_process !!}',
            output_process: '{!! $manufacturing->output_process !!}',
            pic: '{!! $manufacturing->pic !!}',
            t_code: '{!! $manufacturing->t_code !!}',
            proses: '{!! $manufacturing->proses !!}',
            link_terkait: '{!! $manufacturing->link_terkait !!}',
            urutan: '{!! $manufacturing->urutan !!}',
