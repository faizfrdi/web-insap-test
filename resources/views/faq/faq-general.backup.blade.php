        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item active">
                <div class="card-wrapper position-relative">
                    <div class="card shadow-sm h-100 text-center" style="background-color: #007bff; color: white; border-radius: 15px;" onclick="showFilterModal('FAQ Jasa Konstruksi', 'jasa-konstruksi', event)">
            ...
            <div class="carousel-item">
                <div class="card-wrapper position-relative">
                    <div class="card shadow-sm h-100 text-center" style="background-color: #28a745; color: white; border-radius: 15px;" onclick="showFilterModal('FAQ Manufacturing', 'manufacturing', event)">
                        <div class="card-body d-flex flex-column justify-content-center align-items-center">
                            <i class="bi bi-gear card-icon"></i>
                            <h5 class="card-title mb-3">FAQ MANUFACTURING</h5>
                            <p class="card-text">Klik di sini untuk menemukan jawaban tentang Manufacturing.</p>
                        </div>
            ...
            <div class="carousel-item">
                <div class="card-wrapper position-relative">
                    <div class="card shadow-sm h-100 text-center" style="background-color: #ec1c24; color: white; border-radius: 15px;" onclick="showFilterModal('FAQ Jasa Non Konstruksi', 'jasa-non-konstruksi', event)">
                        <div class="card-body d-flex flex-column justify-content-center align-items-center">
                            <i class="bi bi-tools card-icon"></i>
                            <h5 class="card-title mb-3">FAQ JASA NON KONSTRUKSI</h5>
                            <p class="card-text">Klik di sini untuk menemukan jawaban tentang Jasa Non Konstruksi.</p>
                        </div>
            ...
            <div class="carousel-item">
                <div class="card-wrapper position-relative">
                    <div class="card shadow-sm h-100 text-center" style="background-color: #17a2b8; color: white; border-radius: 15px;" onclick="showFilterModal('FAQ Capex Procurement', 'capex-procurement', event)">
                        <div class="card-body d-flex flex-column justify-content-center align-items-center">
                            <i class="bi bi-cart card-icon"></i>
                            <h5 class="card-title mb-3">FAQ CAPEX PROCUREMENT</h5>
                            <p class="card-text">Klik di sini untuk menemukan jawaban tentang Capex Procurement.</p>
                        </div>
            ...
            <div class="carousel-item">
                <div class="card-wrapper position-relative">
                    <div class="card shadow-sm h-100 text-center" style="background-color: #fd7e14; color: white; border-radius: 15px;" onclick="showFilterModal('FAQ Internal Project', 'internal-project', event)">
                        <div class="card-body d-flex flex-column justify-content-center align-items-center">
                            <i class="bi bi-briefcase card-icon"></i>
                            <h5 class="card-title mb-3">FAQ INTERNAL PROJECT</h5>
                            <p class="card-text">Klik di sini untuk menemukan jawaban tentang Internal Project.</p>
                        </div>
