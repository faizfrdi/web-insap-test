...
@section('title', 'Daftar FAQ CO/FM Module - Jasa Konstruksi')
...
<div class="container mt-4">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h1 class="mb-0">Daftar FAQ CO/FM Module - Jasa Konstruksi</h1>
    </div>
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center mb-3 mobile-layout">
                <a href="{{ route('faq-jasa-konstruksi.co-fm-module.create') }}" class="btn btn-primary d-flex align-items-center shadow-sm" style="font-weight: 500; font-size: 0.9rem; padding: 0.5rem 1rem; border-radius: 0.5rem; width: fit-content;">
                    <i class="bi bi-plus-circle me-2" style="font-size: 1rem;"></i> Tambah
                </a>
                <form class="search-form" role="search" method="GET" action="{{ route('faq-jasa-konstruksi.co-fm-module.index') }}">
            ...
            <div class="d-flex align-items-center mb-3">
                ...
                <form id="entriesPerPageForm" action="{{ route('faq-jasa-konstruksi.co-fm-module.index') }}" method="GET">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                @if($faq->image)
                                    <img src="{{ asset('images/faq-jasa-konstruksi/co-fm/' . $faq->image) }}" alt="FAQ Image" style="width: 100px; height: auto; border: 1px solid #ddd; padding: 5px; border-radius: 8px;">
                                @else
                            ...
                            <td class="text-start">
                                <div class="d-flex flex-wrap gap-2">
                                    <a href="{{ route('faq-jasa-konstruksi.co-fm-module.edit', $faq->id) }}" class="btn btn-sm btn-warning">
                        ...
                        @empty
                        <tr>
                            <td colspan="5" class="text-center">Tidak ada data FAQ jasa konstruksi</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form method="POST" action="{{ route('faq-jasa-konstruksi.co-fm-module.destroy', $faq->id) }}">
                        @csrf
                        @method('DELETE')
