...
@section('content')
    ...
    <section id="hero" class="container-fluid text-center py-5" style="background-image: url('{{ asset('images/adhi-tower.jpg') }}'); background-size: cover; background-position: center; position: relative; border-radius: 15px; overflow: hidden; margin: auto; transition: background-image 1s ease-in-out;">
        <div class="overlay" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; background-color: rgba(0, 0, 0, 0.5); z-index: 1;"></div> <!-- Overlay for darker background -->
    ...
    <script>
        $(document).ready(function() {
            var images = [
                "{{ asset('images/adhi-tower.jpg') }}",
                "{{ asset('images/gedung-mth27.jpeg') }}",
            ];
            var currentIndex = 0;
    ...
    <div id="manufacturing-section" class="text-center p-3 p-md-5 mt-5" style="border-radius: 15px; border: 1px solid #ddd; background-color: #fbfbfd;">
        <h2 class="section-title mb-4" style="font-size: min(24px, 5vw);">MANUFACTURING</h2>

        <!-- Module Selection Button dengan ID Unik -->
        <div class="mb-4 d-flex justify-content-between">
            <button id="openModuleModalBtnManufacturing" class="btn btn-custom-red btn-sm" data-bs-toggle="modal" data-bs-target="#moduleSelectionModalManufacturing">
                <i class="bi bi-filter me-1"></i> Pilih Module
            </button>
        </div>

        <!-- Existing content container -->
        <div id="manufacturing-content">
            <div class="row">
                @foreach ($manufacturings as $manufacturing)
                    ...
                    <div class="custom-col mb-4 manufacturing-card {{ $manufacturing->module == 'FI Module' ? 'fi-module' : '' }}" data-module="{{ $manufacturing->module }}">
                        <a href="{{ route('scenarios.manufacturing', $manufacturing->slug) }}" class="text-decoration-none">
                            <div class="card h-100 portfolio-card" style="border-radius: 10px; overflow: hidden; padding: 0; background-color: {{ $backgroundColor }}; background-size: cover; background-position: center;"> 
                                <div class="card-body" style="background: rgba(255,255,255,0.15); color: black;">
                                    ...
                                    <h5 class="card-title">{{ $manufacturing->judul }}</h5>
                                </div>
                            </div>
                        </a>
                    </div>
    ...
    <!-- Modal dengan ID Unik untuk Manufacturing -->
    <div class="modal fade" id="moduleSelectionModalManufacturing" tabindex="-1" aria-labelledby="moduleSelectionModalLabelManufacturing" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="moduleSelectionModalLabelManufacturing">Pilih Module</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="module-filter-container">
                        ...
                        <!-- Checkbox untuk memilih semua module -->
                        <div class="form-check mb-3">
                            <input class="form-check-input module-checkbox" type="checkbox" id="selectAllModulesManufacturing">
                            <label class="form-check-label" for="selectAllModulesManufacturing">Semua Module</label>
                        </div>
                        ...
                        @foreach($modules as $module)
                            <div class="form-check mb-2">
                                <input class="form-check-input module-checkbox" type="checkbox" value="{{ $module }}" id="{{ str_replace(' ', '_', $module) }}_Manufacturing">
                                <label class="form-check-label" for="{{ str_replace(' ', '_', $module) }}_Manufacturing">
                                    {{ $module }}
                                </label>
                            </div>
                        @endforeach
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
                    <button type="button" class="btn btn-primary" id="applyModuleFilterBtnManufacturing">Pilih</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <!-- Toast Container -->
    <div class="position-fixed" style="top: 103px; right: 20px; z-index: 2000;">
        <div id="toastAlertManufacturing" class="toast align-items-center text-white border-0" role="alert" aria-live="assertive" aria-atomic="true" data-bs-delay="3000" style="background-color: #ec1c24; display: none;">
            <div class="d-flex">
                <div class="toast-body">
                    <i class="bi bi-exclamation-circle-fill me-2"></i> Silakan pilih module terlebih dahulu.
                </div>
    ...
    <!-- Jasa Non Konstruksi Section -->
    <div id="jasa-non-konstruksi-section" class="text-center p-3 p-md-5 mt-5" style="border-radius: 15px; border: 1px solid #ddd; background-color: #fbfbfd;">
        <h2 class="section-title mb-4" style="font-size: min(24px, 5vw);">JASA NON KONSTRUKSI</h2>

        <!-- Module Selection Button dengan ID Unik -->
        <div class="mb-4 d-flex justify-content-between">
            <button id="openModuleModalBtnJasaNonKonstruksi" class="btn btn-custom-red btn-sm" data-bs-toggle="modal" data-bs-target="#moduleSelectionModalJasaNonKonstruksi">
                <i class="bi bi-filter me-1"></i> Pilih Module
            </button>
        </div>
    ...
    <!-- Modal dengan ID Unik untuk Jasa Non Konstruksi -->
    <div class="modal fade" id="moduleSelectionModalJasaNonKonstruksi" tabindex="-1" aria-labelledby="moduleSelectionModalLabelJasaNonKonstruksi" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="moduleSelectionModalLabelJasaNonKonstruksi">Pilih Module</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="module-filter-container">
                        <!-- Teks Jasa Non Konstruksi -->
                        <p class="text-muted">Jasa Non Konstruksi</p>

                        <!-- Checkbox untuk memilih semua module -->
                        <div class="form-check mb-3">
                            <input class="form-check-input module-checkbox" type="checkbox" id="selectAllModulesJasaNonKonstruksi">
                            <label class="form-check-label" for="selectAllModulesJasaNonKonstruksi">Semua Module</label>
                        </div>
                        ...
                        @foreach($modules as $module)
                            <div class="form-check mb-2">
                                <input class="form-check-input module-checkbox" type="checkbox" value="{{ $module }}" id="{{ str_replace(' ', '_', $module) }}_JasaNonKonstruksi">
                                <label class="form-check-label" for="{{ str_replace(' ', '_', $module) }}_JasaNonKonstruksi">
                                    {{ $module }}
                                </label>
                            </div>
                        @endforeach
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
                    <button type="button" class="btn btn-primary" id="applyModuleFilterBtnJasaNonKonstruksi">Pilih</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <!-- Toast Container -->
    <div class="position-fixed" style="top: 103px; right: 20px; z-index: 2000;">
        <div id="toastAlertJasaNonKonstruksi" class="toast align-items-center text-white border-0" role="alert" aria-live="assertive" aria-atomic="true" data-bs-delay="3000" style="background-color: #ec1c24; display: none;">
            <div class="d-flex">
                <div class="toast-body">
                    <i class="bi bi-exclamation-circle-fill me-2"></i> Silakan pilih module terlebih dahulu.
                </div>
    ...
    <!-- Capex Procurement Section -->
    <div id="capex-procurement-section" class="text-center p-3 p-md-5 mt-5" style="border-radius: 15px; border: 1px solid #ddd; background-color: #fbfbfd;">
        <h2 class="section-title mb-4" style="font-size: min(24px, 5vw);">CAPEX PROCUREMENT</h2>

        <!-- Module Selection Button dengan ID Unik -->
        <div class="mb-4 d-flex justify-content-between">
            <button id="openModuleModalBtnCapexProcurement" class="btn btn-custom-red btn-sm" data-bs-toggle="modal" data-bs-target="#moduleSelectionModalCapexProcurement">
                <i class="bi bi-filter me-1"></i> Pilih Module
            </button>
        </div>

        <!-- Existing content container -->
        <div id="capex-procurement-content">
            <div class="row">
                @foreach ($capexProcurements as $capex_procurement)
                    ...
                    <div class="custom-col mb-4 capex-card {{ $capex_procurement->module == 'FI Module' ? 'fi-module' : '' }}" data-module="{{ $capex_procurement->module }}">
                        <a href="{{ route('scenarios.capex-procurement', $capex_procurement->slug) }}" class="text-decoration-none">
                            <div class="card h-100 portfolio-card" style="border-radius: 10px; overflow: hidden; padding: 0; background-color: {{ $backgroundColor }}; background-size: cover; background-position: center;"> 
                                <div class="card-body" style="background: rgba(255,255,255,0.15); color: black;">
                                    ...
                                    <h5 class="card-title">{{ $capex_procurement->judul }}</h5>
                                </div>
                            </div>
                        </a>
                    </div>
    ...
    <!-- Modal dengan ID Unik untuk Capex Procurement -->
    <div class="modal fade" id="moduleSelectionModalCapexProcurement" tabindex="-1" aria-labelledby="moduleSelectionModalLabelCapexProcurement" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="moduleSelectionModalLabelCapexProcurement">Pilih Module</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="module-filter-container">
                        <!-- Teks Capex Procurement -->
                        <p class="text-muted">Capex Procurement</p>

                        <!-- Checkbox untuk memilih semua module -->
                        <div class="form-check mb-3">
                            <input class="form-check-input module-checkbox" type="checkbox" id="selectAllModulesCapexProcurement">
                            <label class="form-check-label" for="selectAllModulesCapexProcurement">Semua Module</label>
                        </div>
                        ...
                        @foreach($modules as $module)
                            <div class="form-check mb-2">
                                <input class="form-check-input module-checkbox" type="checkbox" value="{{ $module }}" id="{{ str_replace(' ', '_', $module) }}_CapexProcurement">
                                <label class="form-check-label" for="{{ str_replace(' ', '_', $module) }}_CapexProcurement">
                                    {{ $module }}
                                </label>
                            </div>
                        @endforeach
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
                    <button type="button" class="btn btn-primary" id="applyModuleFilterBtnCapexProcurement">Pilih</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <!-- Toast Container -->
    <div class="position-fixed" style="top: 103px; right: 20px; z-index: 2000;">
        <div id="toastAlertCapexProcurement" class="toast align-items-center text-white border-0" role="alert" aria-live="assertive" aria-atomic="true" data-bs-delay="3000" style="background-color: #ec1c24; display: none;">
            <div class="d-flex">
                <div class="toast-body">
                    <i class="bi bi-exclamation-circle-fill me-2"></i> Silakan pilih module terlebih dahulu.
                </div>
    ...
    <div id="internal-project-section" class="text-center p-3 p-md-5 mt-5" style="border-radius: 15px; border: 1px solid #ddd; background-color: #fbfbfd;">
        <h2 class="section-title mb-4" style="font-size: min(24px, 5vw);">INTERNAL PROJECT</h2>

        <!-- Module Selection Button dengan ID Unik -->
        <div class="mb-4 d-flex justify-content-between">
            <button id="openModuleModalBtnInternalProject" class="btn btn-custom-red btn-sm" data-bs-toggle="modal" data-bs-target="#moduleSelectionModalInternalProject">
                <i class="bi bi-filter me-1"></i> Pilih Module
            </button>
        </div>

        <!-- Existing content container -->
        <div id="internal-project-content">
            <div class="row">
                @foreach ($internalProjects as $internal_project)
                    ...
                    <div class="custom-col mb-4 internal-card {{ $internal_project->module == 'FI Module' ? 'fi-module' : '' }}" data-module="{{ $internal_project->module }}">
                        <a href="{{ route('scenarios.internal-project', $internal_project->slug) }}" class="text-decoration-none">
                            <div class="card h-100 portfolio-card" style="border-radius: 10px; overflow: hidden; padding: 0; background-color: {{ $backgroundColor }}; background-size: cover; background-position: center;"> 
                                <div class="card-body" style="background: rgba(255,255,255,0.15); color: black;">
                                    ...
                                    <h5 class="card-title">{{ $internal_project->judul }}</h5>
                                </div>
                            </div>
                        </a>
                    </div>
    ...
    <!-- Modal dengan ID Unik untuk Internal Project -->
    <div class="modal fade" id="moduleSelectionModalInternalProject" tabindex="-1" aria-labelledby="moduleSelectionModalLabelInternalProject" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="moduleSelectionModalLabelInternalProject">Pilih Module</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="module-filter-container">
                        <!-- Teks Internal Project -->
                        <p class="text-muted">Internal Project</p>

                        <!-- Checkbox untuk memilih semua module -->
                        <div class="form-check mb-3">
                            <input class="form-check-input module-checkbox" type="checkbox" id="selectAllModulesInternalProject">
                            <label class="form-check-label" for="selectAllModulesInternalProject">Semua Module</label>
                        </div>
                        ...
                        @foreach($modules as $module)
                            <div class="form-check mb-2">
                                <input class="form-check-input module-checkbox" type="checkbox" value="{{ $module }}" id="{{ str_replace(' ', '_', $module) }}_InternalProject">
                                <label class="form-check-label" for="{{ str_replace(' ', '_', $module) }}_InternalProject">
                                    {{ $module }}
                                </label>
                            </div>
                        @endforeach
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
                    <button type="button" class="btn btn-primary" id="applyModuleFilterBtnInternalProject">Pilih</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <!-- Toast Container -->
    <div class="position-fixed" style="top: 103px; right: 20px; z-index: 2000;">
        <div id="toastAlertInternalProject" class="toast align-items-center text-white border-0" role="alert" aria-live="assertive" aria-atomic="true" data-bs-delay="3000" style="background-color: #ec1c24; display: none;">
            <div class="d-flex">
                <div class="toast-body">
                    <i class="bi bi-exclamation-circle-fill me-2"></i> Silakan pilih module terlebih dahulu.
                </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Tambahkan setup serupa untuk section lainnya dengan ID dan elemen yang sesuai
            setupFilter(
                'manufacturing-section', 
                '.manufacturing-card', 
                'moduleSelectionModalManufacturing', 
                'toastAlertManufacturing'
            );

            setupFilter(
                'jasa-non-konstruksi-section', 
                '.jasa-non-card', 
                'moduleSelectionModalJasaNonKonstruksi', 
                'toastAlertJasaNonKonstruksi'
            );

            setupFilter(
                'capex-procurement-section', 
                '.capex-card', 
                'moduleSelectionModalCapexProcurement', 
                'toastAlertCapexProcurement'
            );

            setupFilter(
                'internal-project-section', 
                '.internal-card', 
                'moduleSelectionModalInternalProject', 
                'toastAlertInternalProject'
            );
        });
    </script>
