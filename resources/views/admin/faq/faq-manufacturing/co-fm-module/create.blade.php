...
@section('title', 'Tambah FAQ CO/FM Module - Manufacturing')
...
<div class="container mt-4">
    <div class="card card-custom">
        <div class="card-header-custom">
            <h4 class="mb-0">Tambah FAQ CO/FM Module Baru - Manufacturing</h4>
        </div>
        <div class="card-body">
            @if ($errors->any())
            ...
            <form id="createForm" action="{{ route('faq-manufacturing.co-fm-module.store') }}" method="POST" enctype="multipart/form-data" novalidate>
                @csrf
                <div class="mb-3">
