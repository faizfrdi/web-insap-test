...
@section('title', 'Edit FAQ PS Module - Jasa Konstruksi')
...
<div class="container mt-4">
    <div class="card card-custom">
        <div class="card-header-custom">
            <h4 class="mb-0">Edit FAQ PS Module - Jasa Konstruksi</h4>
        </div>
        <div class="card-body">
            @if ($errors->any())
            ...
            <form id="editForm" action="{{ route('faq-jasa-konstruksi.ps-module.update', $faq->id) }}" method="POST" enctype="multipart/form-data" novalidate>
                @csrf
                @method('PUT')
                ...
                <div class="mb-3">
                    ...
                    @if ($faq->image)
                        <div class="text-center mt-3">
                            ...
                            <img src="{{ asset('images/faq-jasa-konstruksi/ps/' . $faq->image) }}" 
                                alt="{{ $faq->question }}" 
                ...
                <div class="d-flex mt-3">
                    <a href="{{ route('faq-jasa-konstruksi.ps-module.index') }}" class="btn btn-secondary me-2 btn-custom">Batal</a>
